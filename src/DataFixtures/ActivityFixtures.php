...
class ActivityFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $activity1->setDomain($this->getReference('domain_1'));
        $activity1->setSkill($this->getReference('skill_1'));
        $activity1->setStyle($this->getReference('style_1'));
        $manager->persist($activity1);

        $activity2 = new Activity();

        $activity2->setUser($this->getReference('user_2'));
        $activity2->setDomain($this->getReference('domain_2'));
        $activity2->setSkill($this->getReference('skill_2'));
        $activity2->setStyle($this->getReference('style_2'));
        ...
        $activity3->setSkill($this->getReference('skill_2'));
        $activity3->setStyle($this->getReference('style_3'));
        $manager->persist($activity3);

        $activity4 = new Activity();

        $activity4->setUser($this->getReference('user_4'));
        $activity4->setDomain($this->getReference('domain_1'));
        $activity4->setStyle($this->getReference('style_2'));
